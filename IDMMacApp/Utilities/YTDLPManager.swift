...
final class YTDLPManager: ObservableObject {
    ...
    private var nonContainerManagedURL: URL {
        ...
        return home.appendingPathComponent("Library/Application Support/IDMMac/yt-dlp")
    }
    
    private init() {
        // Store yt-dlp in Application Support
        let appSupportURL = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
        self.applicationSupportURL = appSupportURL.appendingPathComponent("IDMMac", isDirectory: true)
