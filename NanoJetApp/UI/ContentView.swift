        ...
        .toolbar {
            ...
            ToolbarItem(placement: .primaryAction) {
                Menu {
                    ...
                    Divider()
                    // "Check for Updates" removed for App Store - Apple handles updates
                    Button {
                    ...
                    Button {
                        ...
                        Label("About NanoJet", systemImage: "info.circle")
                    }
                } label: {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                HStack {
                    ...
                    Button("Send") {
                        ...
                        if let url = URL(string: "mailto:info@ahmedsam.com?subject=Feedback%20from%20NanoJet&body=\(body)") {
                            NSWorkspace.shared.open(url)
